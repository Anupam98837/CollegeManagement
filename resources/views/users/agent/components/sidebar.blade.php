...
<body>
  ...
  <div class="as-slim-sidebar">
    ...
    <!-- Navigation -->
    <nav class="as-nav">
      <a href="/agent/dashboard" class="as-nav-link" title="Dashboard">
      ...
      <div class="as-dropdown">
        <a href="/agent/student/register" class="as-nav-link" title="Student" onclick="toggleDropdown(event)">
          <i class="fa-solid fa-user"></i>
          <span>Student</span>
          <i class="fa-solid fa-chevron-down ms-auto"></i>
        </a>
        <div class="as-submenu">
          <a href="/agent/student/register" class="as-nav-link">Register</a>
          <a href="/agent/student/details" class="as-nav-link">Student Details</a>
        </div>
      </div>
      <a href="/agent/profile" class="as-nav-link" title="Profile">
