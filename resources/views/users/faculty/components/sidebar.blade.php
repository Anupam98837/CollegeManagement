...
<body>
  ...
  <div class="as-slim-sidebar">
    ...
    <!-- Navigation -->
    <nav class="as-nav">
      <a href="/faculty/dashboard" class="as-nav-link" title="Dashboard">
      ...
      <div class="as-dropdown">
        <a href="/faculty/student/details" class="as-nav-link" title="Students" onclick="toggleDropdown(event)">
          <i class="fa-solid fa-user"></i>
          <span>Students</span>
          <i class="fa-solid fa-chevron-down ms-auto"></i>
        </a>
        <div class="as-submenu">
          <a href="/faculty/student/details" class="as-nav-link">students</a>
      ...
      <div class="as-dropdown">
        <a href="/faculty/student/details" class="as-nav-link" title="Students" onclick="toggleDropdown(event)">
          <i class="fa-solid fa-user"></i>
          <span>Ateendence</span>
          <i class="fa-solid fa-chevron-down ms-auto"></i>
        </a>
        <div class="as-submenu">
          <a href="/faculty/student/attendance" class="as-nav-link">Ateendence</a>
          <a href="/faculty/student/attendance/report" class="as-nav-link">Ateendence Report</a>
  ...
  <script>
    ...
    document.getElementById("logoutButton").addEventListener("click", async function(event) {
      ...
      try {
        const response = await fetch("/api/institution-role-logout", {
          method: "POST",
          headers: {
