...
<body>
        ...
        <div class="w-100 main-com">
            ...
            <div class="admin_ragister_form">
                ...
                <div class="admin_ragister_student_form_con">
                    <p class=" mb-4 text-secondary text-14"><i class="fa-solid fa-angle-right"></i> <span class="text-primary ">Register</span> </p>
                    <form class="admin_ragister_student_form bg-white"  id="multiStepForm"  enctype="multipart/form-data" novalidate>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control placeholder-14 text-13" id="studentName" name="name" placeholder="Enter student name" value="{{ old('name') }}" readonly required>
                        </div>
                        <!-- Phone -->
                        <div class="col-md-6">
                            <label for="phone" class="form-label text-13">Phone <span class="text-danger">*</span></label>
                            <input type="number" class="form-control placeholder-14 text-13" id="phone" name="phone" placeholder="Enter phone number" readonly required>
                        </div>
                        <!-- Phone -->
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control placeholder-14 text-13" id="email" name="email" placeholder="Enter email" readonly required>
                        </div>
                        <!-- Email -->
                        <div class="col-md-6">
                    ...
                    <div  class=" p-4 rounded mb-4 text-center d-flex d-none flex-column justify-content-center align-items-center vh-50 ragister_complete_message_div">
                        <img src="{{ asset('assets/web_assets/done.png') }}" alt="" style="width: 300px;">
                        <h4 class="alert-heading">Registration Complete!</h4>
                        <p class="fs-5">Your registration has been successfully completed.</p>
                        <button id="editDetailsBtn" class="btn btn-primary d-none">Edit Details</button>
                        <a href="/student/profile" ><button class="btn btn-primary">View Profile</button></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{{ asset('js/Users/student/registerStudent.js') }}"></script>
